        ...
        <div className="relative flex items-center justify-center w-full h-full">
          ...
          >
            <div
              ...
              className="w-full rounded-[32px] border-[2px] backdrop-blur-[6px] flex flex-col  border-[#FFF]/[0.8] bg-[rgba(29,31,39,0.30)] items-center px-[20px] md:px-[49px] py-[51px] gap-[24px] relative "
            >
              <span
